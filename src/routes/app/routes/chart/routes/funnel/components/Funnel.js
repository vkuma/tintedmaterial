...
const Funnel = () => (
  <div className="container-fluid no-breadcrumb">
    ...
    <div className="row">
      <div className="col-xl-6">
        ...
        <div className="box box-default">
          ...
          <div className="box-body">
            <ReactEcharts option={funnel1.options} showLoading={false} theme={"macarons"} />
          </div>
        </div>
      ...
      <div className="col-xl-6">
        ...
        <div className="box box-default">
          ...
          <div className="box-body">
            <ReactEcharts option={funnel2.options} showLoading={false} theme={"macarons"} />
          </div>
        </div>
    ...
    <div className="box box-default">
      ...
      <div className="box-body">
        <ReactEcharts option={funnel3.options} showLoading={false} theme={"macarons"} />
      </div>
    </div>
