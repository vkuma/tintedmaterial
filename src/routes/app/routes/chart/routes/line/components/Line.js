    ...
    <div className="row">
      <div className="col-xl-6">
        ...
        <div className="box box-default">
          ...
          <div className="box-body">
            <ReactEcharts option={line1.options} showLoading={false} theme={"macarons"} />
          </div>
        </div>
      ...
      <div className="col-xl-6">
        ...
        <div className="box box-default">
          ...
          <div className="box-body">
            <ReactEcharts option={line2.options} showLoading={false} theme={"macarons"} />
          </div>
        </div>
    ...
    <div className="row">
      <div className="col-xl-6">
        ...
        <div className="box box-default">
          ...
          <div className="box-body">
            <ReactEcharts option={line3.options} showLoading={false} theme={"macarons"} />
          </div>
        </div>
      ...
      <div className="col-xl-6">
        ...
        <div className="box box-default">
          ...
          <div className="box-body">
            <ReactEcharts option={line4.options} showLoading={false} theme={"macarons"} />
          </div>
        </div>
