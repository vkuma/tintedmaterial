    ...
    <div className="row">
      <div className="col-xl-6">
        ...
        <div className="box box-default">
          ...
          <div className="box-body">
            <ReactEcharts option={pie1.options} showLoading={false} theme={"macarons"} />
          </div>
        </div>
      ...
      <div className="col-xl-6">
        ...
        <div className="box box-default">
          ...
          <div className="box-body">
            <ReactEcharts option={pie2.options} showLoading={false} theme={"macarons"} />
          </div>
        </div>
    ...
    <div className="row">
      <div className="col-xl-12">
        ...
        <div className="box box-default">
          ...
          <div className="box-body">
            <ReactEcharts option={pie4.options} showLoading={false} theme={"macarons"} />
          </div>
        </div>
