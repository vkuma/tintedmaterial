...
const Icons = () => (
  <article className="article">
    ...
    <div className="box box-default">
      ...
      <div className={`card bg-white ${styles.section_icon}`}>
        ...
        <div className="card-action">
          <a href="https://material.io/icons/" target="_blank" rel="noopener noreferrer" className="color-primary">Complete lists here</a>
        </div>
      </div>
