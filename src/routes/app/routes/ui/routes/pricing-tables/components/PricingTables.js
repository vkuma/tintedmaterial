    ...
    <div className="row">
      <div className="col-md-3 col-xsm-6">
        <section className="pricing-table pricing-table-primary">
          ...
          <footer><a href={DEMO.link} className="btn btn-primary">Buy now</a></footer>
        </section>
      </div>
      ...
      <div className="col-md-3 col-xsm-6">
        <section className="pricing-table pricing-table-success">
          ...
          <footer><a href={DEMO.link} className="btn btn-success">Get it now</a></footer>
        </section>
      </div>
      ...
      <div className="col-md-3 col-xsm-6">
        <section className="pricing-table pricing-table-warning">
          ...
          <footer><a href={DEMO.link} className="btn btn-warning">Get it now</a></footer>
        </section>
      </div>
      ...
      <div className="col-md-3 col-xsm-6">
        <section className="pricing-table pricing-table-danger">
          ...
          <footer><a href={DEMO.link} className="btn btn-danger">Get it now</a></footer>
        </section>
      </div>
    </div>
    ...
    <div className="row">
      <div className="col-md-3 col-xsm-6">
        <section className="pricing-table pricing-table-info">
          ...
          <footer><a href={DEMO.link} className="btn btn-info">Get it now</a></footer>
        </section>
      </div>
      ...
      <div className="col-md-3 col-xsm-6">
        <section className="pricing-table">
          ...
          <footer><a href={DEMO.link} className="btn btn-default">Get it now</a></footer>
        </section>
      </div>
    </div>
  </div>
